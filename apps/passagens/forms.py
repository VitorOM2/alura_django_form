...
class PassagemForms(forms.ModelForm):
    ...
    class Meta:
        """ Classe que pega os campos do módulo passagens para criar o formulário """
        model = Passagem
        fields = '__all__'
        labels = {
...
class PessoaForms(forms.ModelForm):
    """ Cria o formulário de pessoas """
    
    class Meta:
        """ Classe que pega os campos do módulo de Pessoas para criar o formulário """
        model = Pessoa
        exclude = ['nome']
